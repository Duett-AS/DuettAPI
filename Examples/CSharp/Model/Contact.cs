...
namespace IO.Swagger.Model
{
        ...
        public partial class Contact :  IEquatable<Contact>, IValidatableObject
    {
        ...
        public Contact(string name = default(string), string phone1 = default(string), string phone2 = default(string), string mobile = default(string), string email = default(string))
        {
